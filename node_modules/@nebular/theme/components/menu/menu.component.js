...
var NbMenuComponent = /** @class */ (function () {
    ...
    NbMenuComponent.prototype.onItemClick = function (item) {
        ...
        if(item.title == "Home"){
            this.items = 
            [
            {title: "Home", icon: "nb-home", link: "/pages/dashboard", home: true, subMenuHeight: 0, pathMatch:"full", selected:true},    
            {title: "Analytics", icon: "nb-bar-chart", subMenuHeight: 0, pathMatch: "full"},
            {title: "Manage Refills", icon: "nb-keypad", subMenuHeight: 0, pathMatch: "full"},
            {title: "Alarms", icon: "nb-notifications", subMenuHeight: 0, pathMatch: "full"},
            ...
            this.items = 
            [
            {title: "Home", icon: "nb-home", link: "/pages/dashboard", home: true, subMenuHeight: 0, pathMatch:"full"},    
            {title: "Analytics", icon: "nb-bar-chart", subMenuHeight: 0, pathMatch: "full", selected:true},
            {title: "Manage Refills", icon: "nb-keypad", subMenuHeight: 0, pathMatch: "full"},
            {title: "Alarms", icon: "nb-notifications", subMenuHeight: 0, pathMatch: "full"},
            {title: "Set up", icon: "nb-gear", subMenuHeight: 0, pathMatch: "full"}
            ]
        }
        else if(item.title == "Manage Refills"){
            this.items = 
            [
            {title: "Home", icon: "nb-home", link: "/pages/dashboard", home: true, subMenuHeight: 0, pathMatch:"full"},    
            {title: "Analytics", icon: "nb-bar-chart", subMenuHeight: 0, pathMatch: "full"},
            {title: "Manage Refills", icon: "nb-keypad", subMenuHeight: 0, pathMatch: "full", selected:true},
            {title: "Alarms", icon: "nb-notifications", subMenuHeight: 0, pathMatch: "full"},
            {title: "Set up", icon: "nb-gear", subMenuHeight: 0, pathMatch: "full"}
            ]
        }
        else if(item.title == "Set up"){
            this.items = 
            [
            {title: "Home", icon: "nb-home", link: "/pages/dashboard", home: true, subMenuHeight: 0, pathMatch:"full"},    
            {title: "Analytics", icon: "nb-bar-chart", subMenuHeight: 0, pathMatch: "full"},
            {title: "Manage Refills", icon: "nb-keypad", subMenuHeight: 0, pathMatch: "full"},
            {title: "Alarms", icon: "nb-notifications", subMenuHeight: 0, pathMatch: "full"},
            {title: "Set up", icon: "nb-gear", subMenuHeight: 0, pathMatch: "full", selected:true}
            ]
        }
        else if(item.title == "Alarms"){
            this.items = 
            [
            {title: "Home", icon: "nb-home", link: "/pages/dashboard", home: true, subMenuHeight: 0},    
            {title: "Analytics", icon: "nb-bar-chart", subMenuHeight: 0, pathMatch: "full"},
            {title: "Manage Refills", icon: "nb-keypad", subMenuHeight: 0, pathMatch: "full"},
            {title: "Alarms", icon: "nb-notifications", subMenuHeight: 0, pathMatch: "full", pathMatch:"full", selected:true},
            {title: "Set up", icon: "nb-gear", subMenuHeight: 0, pathMatch: "full"}
            ]
        }
