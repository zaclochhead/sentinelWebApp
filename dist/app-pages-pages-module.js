...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(postsService) {
        ...
        this.topTwo = 63.6;
        this.topOneHome = 55;
        this.heightTwoHome = 125.2;
        this.topTwoHome = 63.6;
        this.smallTopOne = 15;
        this.smallHeightTwo = 30;
        this.smallTopTwo = 18.7;
        this.vineyardOneTankTopOne = 15;
        this.vineyardOneTankTopTwo = 18.7;
        this.vineyardOneTankHeightTwo = 30;
        this.DateMetric = "Weekly";
        this.weekCount = 0;
        this.dayCount = 0;
        this.yearCount = 0;
        this.homeTankPercentage = 100;
        this.tankPercentage = 100;
        this.vineyardOnePercentage = 92;
        this.remainingWater = 5000;
        this.totalWater = 5000;
        this.homeTankWater = 5000;
        this.vineyardOneWater = Math.floor((92 / 100) * this.totalWater);
        this.type = 'week';
        ...
        //vineyardOne
        this.vineyardOneTankHeightTwo = (92 / 100) * 30;
        ...
        this.vineyardHeightTemp = (92 / 100) * 125.2;
        var tempChange = 125.2 - this.vineyardHeightTemp;
        this.vineyardTopOneTemp = 55 + tempChange;
        this.vineyardTopTwoTemp = 63.6 + tempChange;
        //vineyardTwo
    ...
    DashboardComponent.prototype.initIoConnection = function () {
        ...
        this.ioConnection = this.postsService.onLevel()
            ...
            // if(this.regularTank && this.select === 1){
            _this.updateWaterUsage(waterLevel);
            // }
        });
        this.ioConnectionTwo = this.postsService.onLevelTwo()
            .subscribe(function (message) {
            var waterLevel = message.level;
            //if(this.regularTank && this.select ===2){
            _this.updateWaterUsageTwo(waterLevel);
            //}
        });
    ...
    DashboardComponent.prototype.updateWaterUsage = function (evt) {
        this.homeTankPercentage = evt;
        this.homeTankWater = Math.floor((evt / 100) * this.totalWater);
        ...
        if (this.select == 1) {
            ...
            this.heightTwoHome = this.heightTwo;
            this.topOneHome = this.topOne;
            this.topTwoHome = this.topTwo;
            this.remainingWater = Math.floor((evt / 100) * this.totalWater);
        }
    };
    DashboardComponent.prototype.updateWaterUsageTwo = function (evt) {
        this.vineyardOnePercentage = evt;
        this.vineyardOneWater = Math.floor((evt / 100) * this.totalWater);
        //changing small tanks height
        this.vineyardOneTankHeightTwo = (evt / 100) * 30;
        var smallHeightChange = 30 - this.vineyardOneTankHeightTwo;
        this.vineyardOneTankTopOne = 15 + smallHeightChange;
        this.vineyardOneTankTopTwo = 18.7 + smallHeightChange;
        if (this.select == 2) {
            this.tankPercentage = evt;
            this.heightTwo = (evt / 100) * 125.2;
            var heightChange = 125.2 - this.heightTwo;
            this.topOne = 55 + heightChange;
            this.topTwo = 63.6 + heightChange;
            this.vineyardHeightTemp = this.heightTwo;
            this.vineyardTopOneTemp = this.topOne;
            this.vineyardTopTwoTemp = this.topTwo;
            this.remainingWater = Math.floor((evt / 100) * this.totalWater);
        }
    };
    ...
    DashboardComponent.prototype.cardSelect = function (card, tankName, percentage) {
        ...
        if (this.select > 2 && this.select < 5) {
        ...
        else if (tankName === 'Home Tank') {
            this.regularTank = true;
            this.heightTwo = this.heightTwoHome;
            this.topOne = this.topOneHome;
            this.topTwo = this.topTwoHome;
            this.remainingWater = this.homeTankWater;
            this.tankPercentage = this.homeTankPercentage;
        }
        else {
            this.regularTank = true;
            this.heightTwo = this.vineyardHeightTemp;
            this.topOne = this.vineyardTopOneTemp;
            this.topTwo = this.vineyardTopTwoTemp;
            this.remainingWater = this.vineyardOneWater;
            this.tankPercentage = this.vineyardOnePercentage;
        }
    };
